...
/**
 * A single-use, time-limited token for confirming ownership of an email address.
 *
 * <p>Stores only the {@code token_hash}. Consumed by setting {@code verifiedAt}; expired/used rows
 * are pruned. Not soft-deleted.
 */
@Getter
@Setter
@Entity
