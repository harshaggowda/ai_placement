...
/**
 * Payload to create the current user's profile. All fields optional except none — a profile may
 * start sparse and be completed over time (see completion percentage).
 */
